...
def draw_anterior_b(seglen, theta, gamma, phi, dh1, dh2, dimension, size_lut, randomize):
    ...
    eyes_br = 200 * (randomize * normrnd(1, 0.3) + (1 - randomize))
    belly_br = 200 * 0.83 * (randomize * normrnd(1, 0.3) + (1 - randomize))
    head_br = 166 * 0.64 * (randomize * normrnd(1, 0.3) + (1 - randomize))
...
def gen_lut_b_tail(n, seglen, d1, d2, t, randomize):
    ...
    random_number_size = randomize * normrnd(0.4, 0.1) + (1 - randomize) * 0.5
